...
function measureRows() {
  return [
    ...
    ['Companions split up in the queue', (result) => String(result.metrics.companion_separations ?? 0)],
    ['Companions moved from their seat zone', (result) => String(result.metrics.companion_overrides)],
